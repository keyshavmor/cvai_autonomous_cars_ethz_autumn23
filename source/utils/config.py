...
def command_line_parser():
    ...
    parser.add_argument(
        '--loss_weight_semseg', type=float, default=0.25, help='Weight of semantic segmentation loss')
    parser.add_argument(
        '--loss_weight_depth', type=float, default=0.75, help='Weight of depth estimation loss')
